...
```{r}
tweet_embed(tweet_url("apreshill", "1367240020944441345"))
```
...
Thanks to Tom Mock for the reactable help, and Jesse Mostipak for the nudge to tweet this in the first place `r emo::ji("raised_hands")`
